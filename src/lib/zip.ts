// Minimal ZIP writer (STORE method, no compression). Dependency-free — the report's
// PDF and Excel are already compact, so bundling them uncompressed avoids pulling in a
// zip library while still producing a single, valid .zip the OS opens normally.
...
/** Build a STORE-method zip Blob from the given files. */
